...
from config import CONNECTOR_SCHEME, DASHBOARD_CONNECTOR_HOST, DASHBOARD_PARTICIPANT_ID, DASHBOARD_PARTICIPANT_ID, DASHBOARD_CONNECTOR_MANAGEMENT_PORT, DASHBOARD_CONNECTOR_CONTROL_PORT, DASHBOARD_CONNECTOR_PUBLIC_PORT, DASHBOARD_CONNECTOR_PROTOCOL_PORT, DASHBOARD_API_KEY, API_KEY_HEADER
